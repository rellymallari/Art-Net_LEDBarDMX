...
//Sonoff
#define SONOFF_ADDRESS 7
#define SONOFF_FIXTURE_NAME "SL-LEDBAR2"
...
struct StoreStruct {
  ...
  // The default values
  IPAddress(2,0,0,SONOFF_ADDRESS), IPAddress(255,0,0,0), IPAddress(2,0,0,1), IPAddress(2,255,255,255), IPAddress(2,0,0,SONOFF_ADDRESS), IPAddress(255,0,0,0), IPAddress(2,255,255,255), IPAddress(2,255,255,255),
  false, true,
  {SONOFF_FIXTURE_NAME}, {SONOFF_FIXTURE_NAME}, "soul-link", "S0ul-L1nk2018", {SONOFF_FIXTURE_NAME}, "soulmpc2018",
  15,
